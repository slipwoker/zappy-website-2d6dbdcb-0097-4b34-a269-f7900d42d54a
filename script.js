document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearError(field) {
      ...
      const wrapper = field.closest('.form-group, .field-wrapper, .input-wrapper') || field.parentNode;
      const existingMsg = wrapper.querySelector('.field-error-message');
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Simulate async submission — replace with actual fetch/XHR as needed
      ...
      if (action && action !== '#') {
        ...
        // No action URL — just show success (static demo)
        setTimeout(function () {
          showFormSuccess();
          contactForm.reset();
          if (submitBtn) {
  ...
  const OBSERVE_SELECTOR = '.fade-in, .slide-up, .slide-in, [data-animate]';

  function initScrollAnimations() {
    const elements = document.querySelectorAll(OBSERVE_SELECTOR);
    if (!elements.length) return;

    // Assign stagger delays for grouped elements
    document.querySelectorAll('[data-animate-group]').forEach(function (group) {
      const children = group.querySelectorAll(OBSERVE_SELECTOR);
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Fernando Vaisman Pastry Chef משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2d6dbdcb-0097-4b34-a269-f7900d42d54a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2d6dbdcb-0097-4b34-a269-f7900d42d54a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2d6dbdcb-0097-4b34-a269-f7900d42d54a';
